...
var createBuffer = null,
    copyBuffer = null,
    convertBytesToString, convertStringToBytes = null;
...
var TPEncryption = function TPEncryption(canvas, key) {
    var that = this;
    that.mat_r = [];
    that.mat_g = [];
    that.mat_b = [];
