/***********************************************************************************************
 * 
 * TESTING BORROWED FROM MOZILLA'S OWN GOOGLE AUTHENTICATION EXAMPLE
 *
 **********************************************************************************************/
const REDIRECT_URL = browser.identity.getRedirectURL();
const CLIENT_ID = "895087444400-4kaco3tuvtonhujtbsjnghrgd1pg2amp.apps.googleusercontent.com";
...
var sendImageBinary = function (token, binaryData) {
    ...
    req.onreadystatechange = function () {
        ...
        if (that.readyState === 4 && that.status === 200) {
            ...
            console.log("readyState = " + that.readyState + "; status = " + that.status + ";");
